...
class Coreset(AL):
    ...
    def select(self, n_query, **kwargs):
        ...
        # Print the shapes of the labeled and unlabeled features
        print(f"Shape of labeled features: {labeled_features.shape}")
        print(f"Shape of unlabeled features: {unlabeled_features.shape}")
        ...
        print(f"Time taken for coreset select: {time_taken:.4f} seconds")  # Print the time taken
